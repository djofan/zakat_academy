...
export default async function MyProgressPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      {/* Per program */}
      <div>
        <h2 className="mb-3 font-semibold text-gray-900">Program Saya</h2>
      ...
      {/* Riwayat Kuis */}
      <div>
        <h2 className="mb-3 font-semibold text-gray-900">Riwayat Kuis</h2>
        {quizAttempts.length === 0 ? (
          ...
          <div className="space-y-3">
            {quizAttempts.map((attempt) => {
              ...
              const correctCount = Object.keys(answers).length > 0 ? attempt.score !== null
